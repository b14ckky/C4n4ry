...
- Because if any Avasory can obsucate it using some crypters, converge it to exe, and run into testing machines, so that's why the command line argument feature is not given. 
